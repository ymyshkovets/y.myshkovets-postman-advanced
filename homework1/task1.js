...
function backslashes(string) {
    ...
    console.log(`The total number of backslashes is ${counter}`);
    return string.split('\\').join('') 
}
console.log(backslashes(text));
